...
一趟一趟地白跑，所以，信件会投递到你的朋友的邮箱里，邮箱可能在公寓的一层，或者家门口，
...
Email到达新浪的MTA后，由于对方使用的是@sina.com的邮箱，因此，
...
所以，一封电子邮件的旅程就是：
发件人 -> MUA(邮件用户代理) -> MTA(邮件传输代理) -> 若干个MTA -> MDA(邮件投递代理) <- MUA <- 收件人
